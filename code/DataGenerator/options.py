...
parser.add_argument('--num_gen', type=int, default=15, help='the desired number of images to generate')
...
parser.add_argument('--FontSize', type=str, default='12/36', help='')
...
parser.add_argument('--EnvDepth', type=int, default=100, help='depth thresh')
